  ...
  return (
    <div className={`border-b p-4 flex items-center justify-between ${className}`}>
      ...
      <div className="flex gap-3 items-center flex-shrink-0">
        ...
        <div className="flex items-center gap-2 px-4 py-1.5 border border-light-borderStrong rounded-lg cursor-pointer bg-white text-sm text-light-text3">
        ...
        <button
          ...
          <span className='relative inline-grid h-8 w-8 place-items-center'>
            <PiBellLight className="w-5 h-5 shrink-0 text-light-text3 absolute" />
          </span>

          <span className="absolute -top-0 -right-0 min-w-[1.05rem] h-[1.05rem] px-1 rounded-full bg-light-bgActive text-light-bg1 text-[10px] font-semibold leading-none flex items-center justify-center border border-light-borderStrong">
            3
          </span>
